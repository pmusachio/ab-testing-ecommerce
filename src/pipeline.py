"""Single entrypoint: download -> clean -> analyze -> serialize. Idempotent.
...
from src.train import ABAnalyzer
...
def run() -> None:
    ...
    log.info("Stage 3/4 - analysis")
    analyzer = ABAnalyzer(clean, data_source=raw_path)
    analyzer.analyze()
